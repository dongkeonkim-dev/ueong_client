...
//                            .transition(.opacity)
                        ...
                        Button(action: {
                                        onDismiss() // MainCaptureView를 닫고 WritePostView로 돌아감
                                    }) {
                                        Text("Back")
                                            .foregroundColor(.white)
                                            .padding()
        ...
        if case .ready = session.state {
            if hasDetectionFailed {
                return NSLocalizedString(
                    ...
                    value: "사물을 찾을 수 없습니다. 각 치수는 8cm보다 커야 합니다.",
                ...
                return NSLocalizedString(
                    ...
                    bundle: AppDataModel.bundleForLocalizedStrings,
                    value: "점을 개체의 중앙에 놓은 다음 Continue버튼을 탭하세요.",
            ...
            return NSLocalizedString(
                ...
                bundle: AppDataModel.bundleForLocalizedStrings,
                value: "사물 전체가 상자 안에 있는지 확인해주세요. 수동으로 크기를 조절하려면 핸들을 드래그하세요.",
