                ...
                switch output {
                    ...
                    case .processingComplete:
                        if !gotError {
                            ...
                            do {
                                // usdz 파일 복사 (커스텀 코드)
                                try FileManager.default.copyItem(at: outputFile, to: destinationURL)
                                print("Successfully copied usdz file to: \(destinationURL.path)")
                            } catch {
                                print("Error copying usdz file: \(error.localizedDescription)")
                            }
