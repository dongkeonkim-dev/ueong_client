...
extension ChatView {
    class ViewModel: ObservableObject {
        ...
        //        func sendMessageOrCreateChat(chatRoomId: Int?, partnerUsername: String, messageContent: String, postId: Int) {
        //            // 기존 채팅방 존재 검사
        //            if let chatRoomId {
        //                // 기존 채팅방이 발견된 경우 메시지 전송
        //                sendMessage(chatRoomId: chatRoomId, content: messageContent)
        //            } else {
        ...
        //                sendMessage(chatRoomId: newChatRoomId, content: messageContent)
        //            }
        //        }
        //
        ...
        //            print("채팅방 ID = \(chatRoomId)에 메시지 전송: 내용 = \(content)")
        //            // DB 작업으로 메시지 저장하기
        //        }
        //
